...
class Bullet(object):
    ...
    def __init__(self, size):
        ...
        self.sound_reload = pg.mixer.Sound("sounds\sounds_Reload.mp3")
        self.sound_shots = pg.mixer.Sound("sounds\sounds_Shots.mp3")
        self.sound_shots2 = pg.mixer.Sound("sounds\sounds_Shots2.mp3")
        self.step = 0
